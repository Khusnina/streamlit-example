...
if choice == '📝 Summarize':
   ...
   if uploaded_file is not None:
      ...
      if st.button('Summarize file'):
         ...
         nltk.word_tokenize(Df['Description'][4])
         nltk.word_tokenize(Df['Description'][5])
         nltk.word_tokenize(Df['Description'][6])
         nltk.word_tokenize(Df['Description'][7])
         nltk.word_tokenize(Df['Description'][8])
         nltk.word_tokenize(Df['Description'][9])
         nltk.word_tokenize(Df['Description'][10])
         nltk.word_tokenize(Df['Description'][11])
